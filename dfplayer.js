!function(e) {
    ...
    t.MEDIA_QUERYS = ["screen and (min-width:340px)", "screen and (min-width:1280px)", "screen and (min-width:1920px)"],
...
, function(e, t, i) {
    ...
    t.getPosition = e=>{
        ...
        if (void 0 !== e) {
            ...
            t = 0 === e.getBoundingClientRect().width ? i.getBoundingClientRect() : e.getBoundingClientRect()
        }
        return {
            width: t.width,
            height: t.height,
...
, function(e, t, i) {
    ...
    t.isVkBox = ()=>{
        ...
        if (!n.isVk())
            return !1;
        return (null === (e = document.querySelector("#mv_player_box")) || void 0 === e ? void 0 : e.hasChildNodes()) || !1
    }
}
, function(e, t, i) {
    "use strict";
    ...
    t.isOkFeedVideo = e=>{
        if (!n.isOk())
            return !1;
        return "absolute" !== window.getComputedStyle(e, null).getPropertyValue("position")
    }
}
, function(e, t, i) {
    "use strict";
...
, function(e, t, i) {
    ...
    t.insertPlayers = ()=>{
        ...
        const t = []
          , i = ()=>{
            ...
            (e=>{
                s.customPlayer().forEach(t=>{
                    if (d.isWraped(t) || u.isOutstream(t) || l.notDisplayDomains() || p.isZeroSize(t) || f.hasBlacklistClasses(t) || v.isGif(t))
                        return;
                    c.wrap(t, "other");
          ...
          , g = ()=>{
            e !== window.location.href && (t.forEach(e=>e.removeFromPage()),
            t.length = 0,
            i()),
...
, function(e, t, i) {
    ...
    t.configYoutubeSrc = e=>{
        if (!e.src.includes("?"))
            return e.src + "?origin=*&enablejsapi=1";
        const t = e.src.includes("origin") ? e.src.replace(n, "origin=*") : e.src + "&origin=*";
...
, function(e, t, i) {
    ...
    t.youtubeFrames = [...document.querySelectorAll("iframe")].filter(e=>e.src.includes("youtu"))
}
, function(e, t, i) {
    "use strict";
    Object.defineProperty(t, "__esModule", {
...
, function(e, t, i) {
    ...
    t.createContainer = ()=>{
        ...
        return e.setAttribute("class", n.PLAYER_CLASS),
...
, function(e, t, i) {
    ...
    t.isWraped = e=>{
        var t, i;
        return e.classList.contains(n.WRAPED_PLAYER_CLASS) || (null === (i = null === (t = e.parentElement) || void 0 === t ? void 0 : t.parentElement) || void 0 === i ? void 0 : i.classList.contains(n.PLAYER_CLASS))
    }
}
, function(e, t, i) {
    "use strict";
    ...
    t.Player = class {
        constructor(e, t, i, n, o) {
            ...
            this.container = t,
            this.DOM = new c.DOMClass(this.container,this.custom_classes,this.aspect_ratio,this.randomizer,this.frame,this.position,this.type);
            const u = p.getWitdhAndHeight(this.container, this.aspect_ratio);
            this.VAST = new a.VASTClass(this.url,this.logger,u),
            this.init()
        }
        init() {
            return n(this, void 0, void 0, (function*() {
                try {
                    ...
                    const e = u.configCreativesForVideo(this.VAST.mediaFiles, this.media_querys);
                    this.DOM.addVideoSource(e),
                    this.VAST.bindActions(this.DOM.video, this.DOM.buttonSkip, this.frame, this.removeFromPage.bind(this), this.DOM.updateSkipButton, this.DOM.progressBar, this.type, this.container),
                    this.create()
                } catch (e) {
                    this.logger.log(new d.ReinitError(e))
                }
                return "youtube" === this.type && v.sendMessage(this.frame),
                this
            }
            ))
        }
        createEventListeners() {
            ...
            this.container.addEventListener("click", e=>{
                this.playAd(),
                this.unsubscribeVPAID = this.initVpaidCreative.map(e=>n(this, void 0, void 0, (function*() {
                    if (e)
                        try {
                            const t = yield e;
                            return t ? t() : null
        ...
        create() {
            if (this.autoPlayFn = this.DOM.appendToRealDOM(),
            this.VAST.containVIPAID) {
                const t = this.DOM.adContainerInit();
                try {
                    this.initVpaidCreative = o.loadVPAID(this.container, this.DOM.video, t, this.VAST.mediaFiles, h.initVPAID, this.randomizer, this.VAST.tracker, this.VAST.creatives.adParameters, this.aspect_ratio, this.logger, this.DOM.setVideoHeight, this.DOM)
                } catch (e) {
                    return this.logger.log(new d.ReinitError(e))
                }
            } else
                this.DOM.setVideoHeight(this.DOM, null);
        ...
        reInitByError() {
            ...
            this.currentRetray >= this.retrays)
                return void this.logger.log(new l.TerminateError("Превышен лимит перезапроса VAST",this.removeFromPage.bind(this)));
            ...
            return n(this, void 0, void 0, (function*() {
                if ("skip" !== e.message) {
                    ...
                    try {
                        ...
                        try {
                            this.player.VAST.vastRespons.ads[0].errorURLTemplates.forEach(e=>{
    ...
    t.loadVPAID = (e,t,i,r,s,o,a,c,u,l,d,h)=>{
        ...
        return r.map(r=>{
            if ("application/javascript" === r.mimeType) {
                return n.addScriptToDocument(r.fileURL, s, o, e, i, a, c, t, u, l, d, h)
            }
            return null
        }
        )
...
, function(e, t, i) {
    ...
    const n = i(2);
    t.addScriptToDocument = (e,t,i,r,s,o,a,c,u,l,d,h)=>new Promise((p,f)=>{
        var v;
        const m = document.createElement("iframe");
        m.classList.add("iframe-" + i),
        m.setAttribute("style", "border:0px;margin:0px;opacity:1;padding:0px;height:0;position:absolute;width:0;top:0;left:0;"),
        r.appendChild(m);
        const g = null === (v = m.contentWindow) || void 0 === v ? void 0 : v.document;
        null == g || g.write(((e,t)=>`<head><style>body{margin:0}</style></head><body><script type="text/javascript" class="${e}" src="${t}" async><\/script></body>`)(i, e));
        const y = null == g ? void 0 : g.querySelector("." + i);
        null == y || y.addEventListener("load", (function() {
            (()=>{
                try {
                    const e = m.contentWindow.getVPAIDAd()
                      , i = t(e, o, a, r, s, c, u, l, d, h);
                    p(i)
                } catch (e) {
                    l.log(new n.ReinitError(e)),
                    f(null)
                }
            }
            )()
        ...
        null == y || y.addEventListener("error", (function() {
            l.log(new n.ReinitError("Ошибка загрузки VPAID")),
            f(null)
        }
        ))
    }
    ...
    t.VASTClass = class {
        ...
        fetch() {
            return n(this, void 0, void 0, (function*() {
                ...
                this.firstAdd.errorURLTemplates = this.decodeURLs(this.firstAdd.errorURLTemplates),
                ...
                this.tracker = new r.VASTTracker(this.vastClient,this.firstAdd,this.creatives)
            }
            ))
        }
        decodeURLs(e) {
        ...
        bindActions(e, t, i, n, r, s, o, c) {
            this.video = e,
            a.commonActions(this.video, this.tracker, this.logger, t, i, n, r, s, o, c)
        }
    }
}
, function(e, t, i) {
    ...
    function p(e) {
        ...
        !t.ERRORCODE || i.isCustomCode || /^[0-9]{3}$/.test(t.ERRORCODE) || (t.ERRORCODE = 900),
    ...
    function v(e) {
        return e.length < 8 ? m(0, 8 - e.length, !1).map((function() {
            return "0"
        }
        )).join("") + e : e
    }
    function m(e, t, i) {
        for (var n = [], r = e < t, s = i ? r ? t + 1 : t - 1 : t, o = e; r ? o < s : o > s; r ? o++ : o--)
            n.push(o);
        return n
    }
    var g = {
    ...
    var y = {
        ...
        resolveVastAdTagURI: function(e, t) {
            return t ? 0 === e.indexOf("//") ? "" + location.protocol + e : -1 === e.indexOf("://") ? t.slice(0, t.lastIndexOf("/")) + "/" + e : e : e
        },
        ...
        parseDuration: function(e) {
            ...
            return isNaN(s) || isNaN(r) || isNaN(n) || r > 3600 || n > 60 ? -1 : s + r + n
        },
        splitVAST: function(e) {
            var t = []
              , i = null;
            return e.forEach((function(n, r) {
                if (n.sequence && (n.sequence = parseInt(n.sequence, 10)),
                n.sequence > 1) {
                    var s = e[r - 1];
        ...
        mergeWrapperAdData: function(e, t) {
            ...
            t.videoClickThroughURLTemplate && e.creatives.forEach((function(e) {
                "linear" !== e.type || null !== e.videoClickThroughURLTemplate && void 0 !== e.videoClickThroughURLTemplate || (e.videoClickThroughURLTemplate = t.videoClickThroughURLTemplate)
            }
            ))
        }
    };
    function T(e, t) {
        var i = new h(t);
        return y.childrenByName(e, "Companion").forEach((function(e) {
            var t = new l;
            ...
            y.childrenByName(e, "TrackingEvents").forEach((function(e) {
                y.childrenByName(e, "Tracking").forEach((function(e) {
                    var i = e.getAttribute("event")
                      , n = y.parseNodeText(e);
                    i && n && (Array.isArray(t.trackingEvents[i]) || (t.trackingEvents[i] = []),
            ...
            t.companionClickThroughURLTemplate = y.parseNodeText(y.childByName(e, "CompanionClickThrough")),
            t.companionClickTrackingURLTemplate = y.parseNodeText(y.childByName(e, "CompanionClickTracking")),
            i.variations.push(t)
        }
        )),
        i
    ...
    function w(e, t) {
        var i = void 0
          , n = new k(t);
        n.duration = y.parseDuration(y.parseNodeText(y.childByName(e, "Duration")));
        ...
        if (null == r)
            ...
            n.skipDelay = y.parseDuration(r);
        var o = y.childByName(e, "VideoClicks");
        o && (n.videoClickThroughURLTemplate = y.parseNodeText(y.childByName(o, "ClickThrough")),
                ...
                if (t && r) {
                    if ("progress" === t) {
                        if (!(i = e.getAttribute("offset")))
                            return;
                        t = "%" === i.charAt(i.length - 1) ? "progress-" + i : "progress-" + Math.round(y.parseDuration(i))
                    }
        ...
        y.childrenByName(e, "MediaFiles").forEach((function(e) {
            y.childrenByName(e, "MediaFile").forEach((function(e) {
                ...
                i && "string" == typeof i && ("true" === (i = i.toLowerCase()) ? t.scalable = !0 : "false" === i && (t.scalable = !1));
                var r = e.getAttribute("maintainAspectRatio");
                r && "string" == typeof r && ("true" === (r = r.toLowerCase()) ? t.maintainAspectRatio = !0 : "false" === r && (t.maintainAspectRatio = !1)),
                n.mediaFiles.push(t)
            }
            ))
        }
        ...
        return c && y.childrenByName(c, "Icon").forEach((function(e) {
            var t = new b;
            ...
            i && (t.iconClickThroughURLTemplate = y.parseNodeText(y.childByName(i, "IconClickThrough")),
            y.childrenByName(i, "IconClickTracking").forEach((function(e) {
                t.iconClickTrackingURLTemplates.push(y.parseNodeText(e))
            }
            ))),
            t.iconViewTrackingURLTemplate = y.parseNodeText(y.childByName(e, "IconViewTracking")),
            n.icons.push(t)
        }
        )),
        n
    ...
    function R(e, t) {
        var i = new E(t);
        return y.childrenByName(e, "TrackingEvents").forEach((function(e) {
            var t = void 0
              , n = void 0;
            y.childrenByName(e, "Tracking").forEach((function(e) {
                t = e.getAttribute("event"),
                n = y.parseNodeText(e),
                t && n && (Array.isArray(i.trackingEvents[t]) || (i.trackingEvents[t] = []),
        ...
        y.childrenByName(e, "NonLinear").forEach((function(e) {
            ...
            t.maintainAspectRatio = y.parseBoolean(e.getAttribute("maintainAspectRatio")),
            t.minSuggestedDuration = y.parseDuration(e.getAttribute("minSuggestedDuration")),
            t.apiFramework = e.getAttribute("apiFramework"),
            y.childrenByName(e, "HTMLResource").forEach((function(e) {
                t.type = e.getAttribute("creativeType") || "text/html",
                t.htmlResource = y.parseNodeText(e)
            ...
            t.nonlinearClickThroughURLTemplate = y.parseNodeText(y.childByName(e, "NonLinearClickThrough")),
    ...
    function _(e) {
        ...
        for (var i in t) {
            ...
            if (-1 !== ["Wrapper", "InLine"].indexOf(n.nodeName)) {
                if (y.copyNodeAttribute("id", e, n),
                y.copyNodeAttribute("sequence", e, n),
                "Wrapper" === n.nodeName)
                    return P(n);
                if ("InLine" === n.nodeName)
                    return C(n)
            }
        }
    }
    ...
    function P(e) {
        ...
        if (i ? t.nextWrapperURL = y.parseNodeText(i) : (i = y.childByName(e, "VASTAdTagURL")) && (t.nextWrapperURL = y.parseNodeText(y.childByName(i, "URL"))),
            ...
            if (-1 !== ["linear", "nonlinear"].indexOf(e.type)) {
                if (e.trackingEvents) {
                    ...
                    var i = function(i) {
                        ...
                        Array.isArray(t.trackingEvents[e.type][i]) || (t.trackingEvents[e.type][i] = []),
                        n.forEach((function(n) {
                            t.trackingEvents[e.type][i].push(n)
                        }
                        ))
                    };
                    for (var n in e.trackingEvents)
                        i(n)
                }
                e.videoClickTrackingURLTemplates && (Array.isArray(t.videoClickTrackingURLTemplates) || (t.videoClickTrackingURLTemplates = []),
                e.videoClickTrackingURLTemplates.forEach((function(e) {
                    t.videoClickTrackingURLTemplates.push(e)
                }
                ))),
                e.videoClickThroughURLTemplate && (t.videoClickThroughURLTemplate = e.videoClickThroughURLTemplate),
                e.videoCustomClickURLTemplates && (Array.isArray(t.videoCustomClickURLTemplates) || (t.videoCustomClickURLTemplates = []),
    ...
    function S(e, t) {
        t.forEach((function(t) {
            ...
            if (t.attributes)
                for (var s in n) {
                    var o = n[s];
                    o.nodeName && o.nodeValue && (i.attributes[o.nodeName] = o.nodeValue)
                }
            for (var a in r) {
                var l = r[a]
                  , d = y.parseNodeText(l);
    ...
    function N(e, t, i) {
        if (t)
            ...
            for (var n = e.length, r = H(e, n), s = 0; s < n; ++s)
                r[s].call(i)
    }
    function D(e, t, i, n) {
        if (t)
            ...
            for (var r = e.length, s = H(e, r), o = 0; o < r; ++o)
                s[o].call(i, n)
    }
    ...
    function B(e, t, i, n) {
        ...
        if ((s = e._events) ? (s.newListener && (e.emit("newListener", t, i.listener ? i.listener : i),
        s = e._events),
        o = s[t]) : (s = e._events = new O,
        e._eventsCount = 0),
        o) {
            if ("function" == typeof o ? o = s[t] = n ? [i, o] : [o, i] : n ? o.unshift(i) : o.push(i),
    ...
    function q() {
        var e = void 0;
        return window.XDomainRequest && (e = new XDomainRequest),
        e
    }
    ...
    U.init = function() {
        this.domain = null,
        U.usingDomains && (!(void 0).active || this instanceof (void 0).Domain || (this.domain = (void 0).active)),
        this._events && this._events !== Object.getPrototypeOf(this)._events || (this._events = new O,
        this._eventsCount = 0),
    ...
    U.prototype.removeListener = function(e, t) {
        ...
        if (i === t || i.listener && i.listener === t)
            0 == --this._eventsCount ? this._events = new O : (delete n[e],
            ...
            if (1 === i.length) {
                if (i[0] = void 0,
                0 == --this._eventsCount)
                    return this._events = new O,
                    this;
                delete n[e]
            } else
                !function(e, t) {
                    for (var i = t, n = i + 1, r = e.length; n < r; i += 1,
                    n += 1)
                        e[i] = e[n];
                    e.pop()
                }(i, r);
    ...
    U.prototype.removeAllListeners = function(e) {
        ...
        if (!(i = this._events))
            return this;
        if (!i.removeListener)
            return 0 === arguments.length ? (this._events = new O,
            this._eventsCount = 0) : i[e] && (0 == --this._eventsCount ? this._events = new O : delete i[e]),
            this;
    ...
    U.prototype.listeners = function(e) {
        ...
        return i && (t = i[e]) ? "function" == typeof t ? [t.listener || t] : function(e) {
    ...
    var z = {
        get: function(e, t, i) {
            var n = "function" == typeof window.ActiveXObject ? new window.ActiveXObject("Microsoft.XMLDOM") : void 0;
            if (!n)
                return i(new Error("FlashURLHandler: Microsoft.XMLDOM format not supported"));
            n.async = !1;
            var r = q();
            r.open("GET", e),
        ...
        get: function(e, t, i) {
            ...
            try {
                ...
                n.onreadystatechange = function() {
                    4 === n.readyState && (200 === n.status ? i(null, n.responseXML) : i(new Error("XHRURLHandler: " + n.statusText)))
                }
                ,
                n.send()
            } catch (e) {
    ...
    var Q = {
        get: function(e, t, i) {
            return i || ("function" == typeof t && (i = t),
            t = {}),
            "undefined" == typeof window || null === window ? Y.get(e, t, i) : X.supported() ? X.get(e, t, i) : z.supported() ? z.get(e, t, i) : i(new Error("Current context is not supported by any of the default URLHandlers. Please provide a custom URLHandler"))
        }
    }
      , G = function e() {
        n(this, e),
        ...
        r(t, [{
            ...
            value: function(e, t) {
                for (var i = arguments.length, n = Array(i > 2 ? i - 2 : 0), r = 2; r < i; r++)
                    n[r - 2] = arguments[r];
                this.emit("VAST-error", Object.assign.apply(Object, [{}, J, t].concat(n))),
                g.track(e, t)
            }
        }, {
            ...
            value: function(e) {
                ...
                var i = e ? g.flatten(this.remainingAds) : this.remainingAds.shift();
            ...
            value: function(e) {
                ...
                return this.initParsingStatus(i),
                this.rootURL = e,
                this.fetchVAST(e).then((function(n) {
                    return i.originalUrl = e,
                    i.isRootVAST = !0,
            ...
            value: function(e, t) {
                ...
                for (var a in s) {
                    ...
                    if ("Error" === c.nodeName) {
                        ...
                        n ? this.rootErrorURLTemplates.push(u) : this.errorURLTemplates.push(u)
                    }
                    if ("Ad" === c.nodeName) {
                        var l = _(c);
                        l ? r.push(l) : this.trackVastError(this.getErrorURLTemplates(), {
                            ERRORCODE: 101
                        })
                    }
                }
            ...
            value: function(e, t) {
                ...
                var p = h.length
                  , f = h[p - 1];
                return 1 === p && null != s && f && !f.sequence && (f.sequence = s),
                !1 === n && (this.remainingAds = y.splitVAST(h),
            ...
            value: function(e, t, i) {
                ...
                return new Promise((function(r) {
                    if (t++,
                    !e.nextWrapperURL)
                        return delete e.nextWrapperURL,
                        r(e);
                    if (t >= n.maxWrapperDepth || -1 !== n.parentURLs.indexOf(e.nextWrapperURL))
                        return e.errorCode = 302,
                        delete e.nextWrapperURL,
                        r(e);
                    e.nextWrapperURL = y.resolveVastAdTagURI(e.nextWrapperURL, i);
                    var s = e.sequence;
                    i = e.nextWrapperURL,
                    n.fetchVAST(e.nextWrapperURL, t, i).then((function(o) {
                        return n.parse(o, {
                            originalUrl: i,
                            wrapperSequence: s,
                            wrapperDepth: t
                        }).then((function(t) {
                            if (delete e.nextWrapperURL,
                            0 === t.length)
                                return e.creatives = [],
                                r(e);
                            t.forEach((function(t) {
            ...
            value: function(e) {
                if (0 === e.ads.length)
                    ...
                    for (var t = e.ads.length - 1; t >= 0; t--) {
                        var i = e.ads[t];
                        (i.errorCode || 0 === i.creatives.length) && (this.trackVastError(i.errorURLTemplates.concat(e.errorURLTemplates), {
        ...
        return r(e, [{
            ...
            value: function() {
                if (K)
                    return K;
                try {
                    K = "undefined" != typeof window && null !== window ? window.localStorage || window.sessionStorage : null
                } catch (e) {
                    K = null
                }
                return K && !this.isStorageDisabled(K) || (K = ee).clear(),
                K
            }
        }, {
        ...
        return r(e, [{
            ...
            value: function(e) {
                var t = this
                  , i = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}
                  , n = Date.now();
                return (i = Object.assign({}, this.defaultOptions, i)).hasOwnProperty("resolveAll") || (i.resolveAll = !1),
                ...
                new Promise((function(r, s) {
                    if (t.cappingFreeLunch >= t.totalCalls)
                        return s(new Error("VAST call canceled – FreeLunch capping not reached yet " + t.totalCalls + "/" + t.cappingFreeLunch));
                    var o = n - t.lastSuccessfulAd;
                    if (o < 0)
                        t.lastSuccessfulAd = 0;
                    else if (o < t.cappingMinimumTimeInterval)
                        return s(new Error("VAST call canceled – (" + t.cappingMinimumTimeInterval + ")ms minimum interval reached"));
                    t.vastParser.getAndParseVAST(e, i).then((function(e) {
                        return r(e)
                    }
                    )).catch((function(e) {
                        return s(e)
      ...
      , ne = function(e) {
        function t(e, i, r) {
            ...
            a.emitAlwaysEvents = ["creativeView", "start", "firstQuartile", "midpoint", "thirdQuartile", "complete", "resume", "pause", "rewind", "skip", "closeLinear", "close"],
            a.creative.trackingEvents) {
                var u = a.creative.trackingEvents[c];
                a.trackingEvents[c] = u.slice(0)
            }
            return a.creative instanceof k ? a._initLinearTracking() : a._initVariationTracking(),
        ...
        r(t, [{
            ...
            value: function() {
                ...
                this.variation) {
                    ...
                    this.variation instanceof L ? (this.clickThroughURLTemplate = this.variation.nonlinearClickThroughURLTemplate,
                    this.clickTrackingURLTemplates = this.variation.nonlinearClickTrackingURLTemplates,
                    this.setDuration(this.variation.minSuggestedDuration)) : this.variation instanceof l && (this.clickThroughURLTemplate = this.variation.companionClickThroughURLTemplate,
            ...
            value: function(e) {
                var t = this
                  , i = this.skipDelay || -1;
                if (-1 === i || this.skippable || (i > e ? this.emit("skip-countdown", i - e) : (this.skippable = !0,
                ...
                this.assetDuration > 0) {
                    ...
                    if (e > 0) {
                        ...
                        this.quartiles)
                            this.isQuartileReached(s, this.quartiles[s], e) && (n.push(s),
            ...
            value: function(e, t, i) {
                var n = !1;
                return t <= i && !this._alreadyTriggeredQuartiles[e] && (n = !0),
                n
            }
        }, {
            key: "setMuted",
            ...
            key: "trackImpression",
            value: function() {
                this.impressed || (this.impressed = !0,
            ...
            value: function(e) {
                ...
                i ? (this.emit(e, ""),
                this.trackURLs(i)) : n && this.emit(e, ""),
                t && (delete this.trackingEvents[e],
                n && this.emitAlwaysEvents.splice(this.emitAlwaysEvents.indexOf(e), 1))
            }
        }, {
            key: "trackURLs",
            value: function(e) {
                var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}
                  , i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {};
                this.linear && (this.creative && this.creative.mediaFiles && this.creative.mediaFiles[0] && this.creative.mediaFiles[0].fileURL && (t.ASSETURI = this.creative.mediaFiles[0].fileURL),
            ...
            value: function() {
                ...
                i.length < 2 && (i = "0" + i);
                var n = e % 60;
                return n.length < 2 && (n = "0" + i),
                t + ":" + i + ":" + n + "." + parseInt(100 * (this.progress - e))
            }
        }]),
        t
    }()
...
, function(e, t, i) {
    ...
    t.VPAIDCondition = e=>"VPAID" === e.apiFramework && "application/javascript" === e.mimeType
}
, function(e, t, i) {
    "use strict";
    Object.defineProperty(t, "__esModule", {
    ...
    t.replaceMacro = (e,t)=>{
        e.getParser().addURLTemplateFilter(e=>e.replace("%5Bwidth%5D", "" + t[0]).replace("%5Bheight%5D", "" + t[1]))
    }
}
, function(e, t, i) {
    "use strict";
    ...
    t.commonActions = (e,t,i,u,l,d,h,p,f,v)=>{
        ...
        const g = e.querySelector("source:last-child")
          , y = ()=>n(void 0, void 0, void 0, (function*() {
            l.classList.remove(c.WRAPED_PLAYER_CLASS),
            "youtube" === f ? o.you_play(l) : (yield l.play(),
            l.paused && l.click())
        }
        ))
          , T = ()=>{
          ...
          , w = ()=>n(void 0, void 0, void 0, (function*() {
            t.complete(),
            y(),
            i.log(new s.TerminateError("end ad",d))
        }
        ))
          , E = e=>{
        ...
        e.addEventListener("canplay", ()=>{
            ...
            "other" === f && (l.addEventListener("timeupdate", k),
            m = !0)
        }
        , {
            once: !0
        ...
        t.on("skip", ()=>{
            y(),
            C(),
            i.log(new s.TerminateError("skip",d))
        }
        ),
        t.on("complete", ()=>{
            y(),
...
, function(e, t, i) {
    ...
    const n = (e,t)=>{
        var i;
        null === (i = e.contentWindow) || void 0 === i || i.postMessage(JSON.stringify({
            event: "command",
            func: t,
            args: []
        }), "*")
    ...
    t.DOMClass = class {
        constructor(e, t, i, n, r, s, o) {
            ...
            this.updateSkipButton = e=>{
                this.buttonSkip.innerHTML = 0 === e ? this.makeEnablade() : "" + String(e)
            }
            ,
        ...
        appendToRealDOM() {
            ...
            return r.appendToRealDOM(this.parentNode, this.video, this.VirtualDOMPlayer, this.position, e),
            u.autoPlayPause(this.parentNode, this.video, this.buttonPlay, this.wrapper)
        }
        removeFromPage() {
            try {
        ...
        adContainerInit() {
            const e = document.createElement("div");
            return e.classList.add(this.Class.adContainer),
        ...
        createComment() {
            const e = document.createComment("Copyright © digitalfrontier. All rights reserved.");
            this.wrapper.appendChild(e)
        }
        createVideo() {
...
, function(e, t, i) {
    ...
    t.inlineCSS = (e,t,i)=>{
        var n;
        const r = ()=>document.location.toString().includes("youtube") || "youtube" === i ? "#fc0" : "#00a1ff"
          , s = document.createElement("style");
        s.innerHTML = `\n\n  .df-player {\n    position: absolute;\n    box-sizing: content-box;\n    cursor: pointer;\n    z-index: 9999999999;\n    font-size: 16px;\n  }\n.${e.playYoutube} {\n    background: none;\n    border: none;\n    cursor: pointer;\n    speak: none;\n    outline: none;\n    -webkit-font-smoothing: antialiased;\n    -moz-osx-font-smoothing: grayscale;\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    height: 100%;\n    width: 3em;\n    padding: 0;\n}\n.${e.playYoutube} svg {\n    left: 0;\n    position: relative;\n    top: 0;\n    width: 100%;\n    fill: #fff;\n}\n\n\n.${e.video} {\n    width: 100%!important;\n    height: 100%;\n    object-fit: cover;\n    grid-area: 1/ -1;\n    cursor: pointer;\n    object-fit: contain;\n    background-color: black;\n}\n\n.${e.controls} {\n    display: flex;\n    list-style: none;\n    width: 97%;\n    justify-content: flex-start;\n    position: absolute;\n    bottom: 0;\n    opacity: 0.6;\n    box-sizing: border-box;\n    align-items: center;\n    margin: 0 1.5%;\n    height: 2em;\n}\n\n.${e.skip}:before {\n    position: relative;\n    display: block;\n    content: "${/en/g.test(navigator.language) ? "Skip" : "Пропустить рекламу"}";\n    padding-right: 5px;\n}\n.${e.skip} {\n    text-shadow: 0 0 4px rgba(0,0,0,0.75);\n    color: #fff;\n    position: absolute;\n    bottom: 4em;\n    right: 1em;\n    fill: rgb(46, 46, 46); \n    border: 1px solid rgba(255,255,255,0.5);\n    border-right: 0;\n    direction: ltr;\n    cursor: pointer;\n    padding: 10px 6px 8px 10px;\n    speak: none;\n    outline: none;\n    -webkit-font-smoothing: antialiased;\n    -moz-osx-font-smoothing: grayscale; \n    display: flex;\n    justify-content: center;\n    align-items: center;\n    height: 2em;\n    font-size: 18px;\n    background: rgba(0,0,0,0.9);\n    opacity: 0.5;\n}\n.${e.skip}:hover {\n  opacity: 1;\n  border: 1px solid rgba(255,255,255,1);\n  background: rgba(0,0,0,0.9);\n  color: #fff;\n}\n.${e.adContainer} {\n    left: 0;\n    width: 100%;\n    height: 100%;\n    padding-top: 10px;\n    grid-area: 1/-1;\n}\n.${e.container} {\n    position: absolute;\n    width: 100%;\n    height: 100%;\n    clear: both;\n    top: 0;\n    display: none;\n}\n\n.${e.progress} {\n    -webkit-appearance: none;\n    appearance: none;\n    width: 100%;\n    color: ${r()};\n    height: 4px;\n    border: none;\n    background: rgba(255,255,255,.4);\n    outline: none;\n    border: none;\n    position: absolute;\n    bottom: 2.2em;\n    width: 97%;\n    margin: 0 1.5%;\n}\n\nprogress.${e.progress}::-webkit-progress-bar {\n    background: rgba(255,255,255,.4);\n  }\nprogress.${e.progress}::-webkit-progress-value {background: ${r()};}\n\nprogress.${e.progress}::-moz-progress-bar {background: ${r()};; }\n\nprogress.${e.progress}[value] {\n    -webkit-appearance: none;\n    appearance: none;\n}\n.${e.container}:hover .${e.controls}, .${e.container}:hover {\n    opacity: 1;\n}\n\n\n@media (min-width: 320px) and (max-width: 767px) {\n    .${e.skip} {\n        font-size: 14px;\n    }\n}`,
        s.classList.add(t);
        const o = document.querySelector("script");
        null === (n = null == o ? void 0 : o.parentNode) || void 0 === n || n.insertBefore(s, o)
    }
}
, function(e, t, i) {
    "use strict";
    ...
    t.appendToRealDOM = (e,t,i,d,h)=>{
        ...
        r.isOk() ? ((e,t,i)=>{
            ...
            null === r || a.isOkFeedVideo(i) ? c(e, t) : u(e, t),
            l(e, r)
        }
        )(e, d, t) : s.isVkBox() ? ((e,t)=>{
            const i = o.findVkBox();
...
, function(e, t, i) {
    ...
    t.createVideo = e=>{
        ...
        return t.classList.add(e.video),
        t.controls = !1,
        n.attributeSetter([{
            attr: "preload",
            value: "auto"
...
, function(e, t, i) {
    ...
    t.createControls = e=>{
        ...
        return a.addEventListener("click", (function() {
            "false" === this.dataset.play ? this.dispatchEvent(s.playEvent) : this.dispatchEvent(s.pauseEvent)
        }
        )),
        t.appendChild(a),
        {
...
, function(e, t, i) {
    ...
    const n = i(11)
      ...
      , s = i(44);
    t.drawPlayButton = e=>{
        const t = e=>`<svg height="100%" version="1.1" viewBox="0 0 36 36" width="100%">${e}</svg>`;
        let i = !1;
        const o = n.createButton("playYoutube", e);
        return o.dataset.play = "" + i,
        o.onclick = ()=>{
            i = !i,
            o.dataset.play = "" + i,
...
, function(e, t, i) {
    ...
    t.playPath = void 0,
    t.playPath = '<path d="M 12,26 18.5,22 18.5,14 12,10 z M 18.5,22 25,18 25,18 18.5,14 z"></path>'
}
, function(e, t, i) {
    "use strict";
    Object.defineProperty(t, "__esModule", {
    ...
    t.pausePath = void 0,
    t.pausePath = '<path d="M 12,26 16,26 16,10 12,10 z M 21,26 25,26 25,10 21,10 z"></path>'
}
, function(e, t, i) {
    "use strict";
    Object.defineProperty(t, "__esModule", {
    ...
    const n = i(4)
      ...
      , h = (e,t,i,n)=>u.isInIframe() ? (e=>{
        e.style.left = "0",
        e.style.top = "0",
        e.style.width = "100%",
        e.style.height = "100%"
    }
    )(e) : s.isYouTubeMini() ? ((e,t)=>{
        e.style.position = "fixed",
        l(e, t),
        e.style.top = String(document.documentElement.clientHeight - t.y),
        e.style.zIndex = "100000"
    }
    )(e, t) : r.isYouTubeWide() ? ((e,t)=>{
        e.style.left = "0",
        e.style.width = t.width + 2 * t.x + "px"
    }
    )(e, t) : a.isVkBox() ? d(e) : o.isOk() && c.isOkFeedVideo(n) ? (e.style.zIndex = "5000",
    void d(e)) : void 0;
...
, function(e, t, i) {
    ...
    t.isYouTubeWide = ()=>{
        var e;
        const t = null === (e = document.querySelector("#player-theater-container")) || void 0 === e ? void 0 : e.querySelector("#player-container");
...
, function(e, t, i) {
    ...
    t.isYouTubeMini = ()=>!!document.querySelector(".ytp-player-minimized")
}
, function(e, t, i) {
    "use strict";
    Object.defineProperty(t, "__esModule", {
...
, function(e, t, i) {
    ...
    t.autoPlayPause = (e,t,i,s)=>{
        const o = ()=>n(void 0, void 0, void 0, (function*() {
            if ("true" === i.dataset.play || !s.style.display)
                return;
            if (!t)
                return window.removeEventListener("scroll", o),
                void window.removeEventListener("resize", o);
            let n = e.getBoundingClientRect();
            n.top > -n.height / 2 && n.bottom <= document.documentElement.clientHeight + n.height / 2 == 1 ? e.dispatchEvent(r.playEvent) : e.dispatchEvent(r.pauseEvent)
        }
        ));
...
, function(e, t, i) {
    ...
    t.configCreativesForVideo = (e,t)=>{
        ...
        return e.sort((e,t)=>e.width < t.width ? -1 : 1).reduce((e,i,n)=>(e.push({
            src: i.fileURL,
            type: i.mimeType,
            media: t[n],
            poster: ""
...
, function(e, t, i) {
    ...
    const n = i(53)
      ...
      , o = i(55)
      , a = i(56);
    t.initVPAID = (e,t,i,c,u,l,d,h,p,f)=>{
        if (!n.checkSpec(e))
            return h.log(new r.ReinitError("VPAID не валиден, так как не предоставляет все обязательные методы")),
            null;
        return ()=>{
            e.handshakeVersion("2.0"),
            e.initAd(u.offsetWidth, u.offsetHeight, "normal", -1, {
                AdParameters: i
            }, {
                slot: u,
                videoSlot: l,
            ...
            , 0);
            const n = s.listenEvents(l, e, t, h, f);
            for (let t in n) {
                const i = n[t];
            ...
            ;
            return window.addEventListener("beforeunload", r, !1),
            r
        }
    }
}
...
, function(e, t, i) {
    ...
    t.sendMessage = e=>{
        n.isIframe(e) && (e.onload = ()=>{
            ...
            null === (t = e.contentWindow) || void 0 === t || t.postMessage(n, "https://www.youtube.com"),
            n = JSON.stringify({
                event: "command",
            ...
            null === (i = e.contentWindow) || void 0 === i || i.postMessage(n, "https://www.youtube.com")
        }
        )
    }
}
...
, function(e, t, i) {
    ...
    t.startListening = (e,t)=>{
        ...
        window.addEventListener("message", i=>{
            ...
            if ("https://www.youtube.com" === i.origin && void 0 !== i.data && r.id === e.frame.id)
                try {
                    if ("onStateChange" !== r.event)
                        return;
